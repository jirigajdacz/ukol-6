...
vyber = input("Jakou značku si přejete půjčit (Peugeot nebo Škoda)? ").strip().lower()

if vyber == "peugeot":
    print(auto1.get_info())
    vysledek = auto1.pujc_auto()
elif vyber == "škoda":
    print(auto2.get_info())
    vysledek = auto2.pujc_auto()
else:
    vysledek = "Neplatný výběr značky."
